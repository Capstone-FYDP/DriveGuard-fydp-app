...
import { humanDateString, humanTimeString, pluralize } from '../../utils/string-utils';
            ...
            <View style={styles.infoCardContent}>
                <View style={styles.attribute}>
                    <IconBadge
                        ...
                        noTouchOpacity
                    />
                    <Text style={styles.attributeText}>{humanDateString(startDate)}  |  {humanTimeString(startDate)}</Text>
                </View>
                {status == "COMPLETED" &&
                    <>
                        <View style={styles.attribute}>
                            <IconBadge
                                ...
                                noTouchOpacity
                            />
                            <Text style={styles.attributeText}>{getDurationString(duration)}</Text>
                        </View>
                        <View style={styles.attribute}>
                            <IconBadge
                                ...
                                noTouchOpacity
                            />
                            <Text style={[styles.attributeText, {color: getIncidentColor(numOfIncidents)}]}>{numOfIncidents} {pluralize("Incident", numOfIncidents)}</Text>
                        </View>
                    </>
                }
                {status == "ACTIVE" &&
                    <>
                        <View style={styles.attribute}>
                            <IconBadge
                                ...
                                noTouchOpacity
                            />
                            <Text style={[styles.attributeText, {color: "#e74c3c", fontWeight: '600'}]}>LIVE</Text>
                        </View>
                    </>
                }
            </View>
